...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>SpringBoard_Set_Archived_Initial_Refer</fullName>
        <field>Archived_Initial_Referrer__c</field>
        <formula>Initial_Referrer__c</formula>
        <name>SpringBoard - Set Archived Initial Refer</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>SpringBoard_Set_Archived_Referrer</fullName>
        <field>Archived_Referrer__c</field>
        <formula>Referrer__c</formula>
        <name>SpringBoard - Set Archived Referrer</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>SpringBoard_Set_Initial_Market_Source</fullName>
        <description>used to set initial market source when initial market source is blank</description>
        <field>Initial_Market_Source__c</field>
        <formula>Market_Source__c</formula>
        <name>SpringBoard - Set Initial Market Source</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
...
OtherPhone 
    ...
    <rules>
        <fullName>SpringBoard - Set Archived Initial Referrer</fullName>
        <actions>
            <name>SpringBoard_Set_Archived_Initial_Refer</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <description>This workflow updates the Archived Initial Referrer field with the Initial Referrer entry that the record was created with.</description>
        <formula>LEN( Archived_Initial_Referrer__c  ) &lt; 1 &amp;&amp; LEN(  Initial_Referrer__c  ) &gt; 2</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>SpringBoard - Set Archived Referrer</fullName>
        <actions>
            <name>SpringBoard_Set_Archived_Referrer</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <description>This workflow updates the Archived Referrer field with the Referrer entry that the record was created with.</description>
        <formula>LEN( Archived_Referrer__c ) &lt; 1 &amp;&amp; LEN(  Referrer__c  ) &gt; 2</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>SpringBoard - Update Initial MS</fullName>
        <actions>
            <name>SpringBoard_Set_Initial_Market_Source</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <description>sets initial ms on contacts</description>
        <formula>LEN( Initial_Market_Source__c ) &lt; 1 &amp;&amp; LEN( Market_Source__c ) &gt; 2</formula>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
